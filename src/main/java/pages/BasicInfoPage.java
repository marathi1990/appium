...
public class BasicInfoPage {
    ...
    private final WebDriverWait wait = new WebDriverWait(DriverManager.driver, Duration.ofSeconds(60));
    ...
    private final By editButton = AppiumBy.id("com.fluenthealth.app:id/editProfileTv");
    ...
    public void scrollDowntilleditdone() {

            WebElement element = DriverManager.driver.findElement(AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().resourceId(\"com.fluenthealth.app:id/editProfileTv\"))"));

    //            AppiumBy.id("com.fluenthealth.app:id/editProfileTv");
    ...
    public void scrollDowntilladddetails() {

            WebElement element = DriverManager.driver.findElement(AppiumBy.androidUIAutomator(
                "new UiScrollable(new UiSelector().scrollable(true))" +
                ".scrollIntoView(new UiSelector().resourceId(\"com.fluenthealth.app:id/txt_add_details\"))"));

    //     new UiSelector().resourceId("com.fluenthealth.app:id/txt_add_details")
    ...
    public void verifyBasicInfoFieldsEditability() {
        ...
        System.out.println("✅ pagesbasicinfopage.java");
        ...
        //. By phoneLocator = AppiumBy.androidUIAutomator("new UiSelector().text(\"91-9594260325\")");
        // WebElement phoneElement = wait.until(ExpectedConditions.visibilityOfElementLocated(phoneLocator));
        // String phoneOriginalText = phoneElement.getText();
        // phoneElement.click();
        // try {.
        //     phoneElement.sendKeys("TEST");
        //     Thread.sleep(500);
        //     String phoneTextAfter = phoneElement.getText();
        //     if (!phoneOriginalText.equals(phoneTextAfter)) {
        //         throw new AssertionError("Phone field should not accept text input (non-editable field)");
        //     }
        // } catch (Exception e) {
        //     // expected for non-editable fields
        // }
